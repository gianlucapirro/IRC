...
static void handleRegistrationNick(Client *client, const std::vector<std::string>& args, CommandHandler *commandHandler) {
...
void CommandHandler::handleRegistration(Client *client, const std::string& command, const std::vector<std::string>& args) {
    if (command == "QUIT") {
        client->del();
