...
#define AERR_NICKNAMEINUSE(client)                       ":ircserv 433 " + client + " " + client  + " :Nickname is already in use\r\n"
...
#define ARPL_WELCOME(client)                             "001 " + client + " :Welcome " + client + " to the ft_irc network"
