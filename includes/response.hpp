...
#define AERR_TOOMANYCHANNELS(client, channel) \
    ":ircserv 405 " + client + " " + channel + " :You have joined too many channels\r\n"
...
#define AERR_CHANOPRIVSNEEDED(client, channel) \
    ":ircserv 482 " + client + " " + channel + " :You're not channel operator\r\n"
#define AERR_NOSUCHNICK(client, nickname) ":ircserv 401 " + client + " " + nickname + " :No such nick/channel\r\n"
#define AERR_USERNOTINCHANNEL(client, nickname, channel) \
    ":ircserv 441 " + client + " " + nickname + " " + channel + " :They aren't on that channel\r\n"
#define AERR_USERONCHANNEL(client, nickname, channel) \
    ":ircserv 443 " + client + " " + nickname + " " + channel + " :is already on channel\r\n"
#define AERR_UNKNOWNMODE(client, mode) ":ircserv 472 " + client + " " + mode + " :is unknown mode char to me\r\n"

#define AERR_INVITEONLYCHAN(client, channel) \
    ":ircserv 473 " + client + " " + channel + " :You are not invited to this channel\r\n"
...
#define ARPL_KICK(client, channel, target, reason) \
    ":" + client + " KICK " + channel + " " + target + " :" + reason + "\r\n"
